...
public class AllCommentAdapter extends CommonAdapter<CommentListBean.ResultdataBean.CommentBean> {
    public AllCommentAdapter(Context context, int layoutId) {
        super(context, layoutId);
    }

    @Override
    public void convert(ViewHolder holder, final CommentListBean.ResultdataBean.CommentBean o, int position) {
