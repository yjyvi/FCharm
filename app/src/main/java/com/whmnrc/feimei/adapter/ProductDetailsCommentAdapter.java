...
public class ProductDetailsCommentAdapter extends CommonAdapter<ProductDetailsBean.ResultdataBean.CommentBean> {
    public ProductDetailsCommentAdapter(Context context, int layoutId) {
        super(context, layoutId);
    }

    @Override
    public void convert(ViewHolder holder, ProductDetailsBean.ResultdataBean.CommentBean o, int position) {
